...
public class OstacoloAdiacenteDietroCondizione implements ICondizione, IStrategiaComponent, Serializable {
    ...
    public OstacoloAdiacenteDietroCondizione(String name, String description, String idType, String idCond, boolean vera, List<Integer> valori) {
        this.name = name;
    ...
    public boolean eseguiti(ITank tankTurno, ITank tankAvversario, CampoBattaglia campo) {
        ...
        OrientamentoEnum orientamentoDietro = OrientamentoEnum.getDietro(orientamentoTankTurno);
        List campoDirezione = campo.getCaselleByOrientamento(casellaTankTurno,orientamentoDietro);
